...
public class DATA_PERPUSTAKAAN {
    ...
    public static void main(String[] args) {
        ...
        dataMahasiswa.add(new Mahasiswa("1", "Eneng Elsa Amelia"));
        dataMahasiswa.add(new Mahasiswa("2", "Dita Indriawati"));
        dataMahasiswa.add(new Mahasiswa("3", "Siti Badriah"));
        
         ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("1", "Dasar Pemrograman"));
    dataBuku.add(new Buku("2", "Bahasa German"));
    dataBuku.add(new Buku("3", "Bahasa sunda"));
